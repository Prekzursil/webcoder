...
class UserPage(TitleMixin, UserMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        levels = [0,0,0,0]
        for b in self.object.user.badges.all():
            levels[int(b.level)-1] += 1
...
class UserList(QueryStringSortMixin, DiggPaginatorMixin, TitleMixin, ListView):
    ...
    template_name = 'user/list-modified.html'
    paginate_by = 100
    all_sorts = frozenset(('points', 'problem_count', 'rating', 'performance_points', 'country'))
