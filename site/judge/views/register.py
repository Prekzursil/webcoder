...
class CustomRegistrationForm(RegistrationForm):
    ...
    first_name = forms.RegexField(regex=r'^[a-zA-Z]+$', max_length=100, label=_('First name'),
                                error_messages={'invalid': _('A username must contain letters, '
                                                             'numbers, or underscores')})
    last_name = forms.RegexField(regex=r'^[a-zA-Z]+$', max_length=100, label=_('Last name'),
                                  error_messages={'invalid': _('A username must contain letters, '
                                                               'numbers, or underscores')})
...
class RegistrationView(OldRegistrationView):
    ...
    def get_initial(self, *args, **kwargs):
        ...
        initial['country'] = settings.DEFAULT_COUNTRY
