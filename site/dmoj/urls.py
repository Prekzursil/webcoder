...
from judge.views.problem_data import ProblemDataView, ProblemSubmissionDiff, \
    problem_data_file, problem_init_view, DownloadTestCase
...
urlpatterns = [
    ...
    url(r'^categories/$', problem.CategoriesList.as_view(), name='categories_list'),
    ...
    url(r'^problem/(?P<problem>[^/]+)', include([
        ...
        url(r'^/case/(?P<name>.+)$$', DownloadTestCase, name='problem_case_file'),
    ...
    url(r'^contests/past/', paged_list_view(contests.PastContestList, 'past_contest_list')),
    ...
    url(r'^badges/', badges.overview, name='badges_overview'),
