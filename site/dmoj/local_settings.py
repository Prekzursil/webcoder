...
ALLOWED_HOSTS = ['45.132.242.201', 'infocode.ro', 'www.infocode.ro']
...
EMAIL_HOST = 'mail.postale.io'
EMAIL_PORT = 587
EMAIL_HOST_USER = 'noreply@infocode.ro'
EMAIL_SUPPORT_USER = 'support@infocode.ro'
EMAIL_HOST_PASSWORD = 'darthvader20'
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'noreply@infocode.ro'
...
ADMINS = (
    ('Vitor Ramalho', 'vitor.ramalho@bct.ect.ufrn.br'),
)

# The sender for the aforementioned emails.
SERVER_EMAIL = 'Infocode: Your code dojo <noreply@infocode.ro>'
...
SITE_NAME = 'Infocode'
SITE_LONG_NAME = 'Infocode: Coding Problems'
SITE_ADMIN_EMAIL = 'admin@infocode.ro'
...
EVENT_DAEMON_GET = 'ws://infocode.ro/event/'
EVENT_DAEMON_GET_SSL = 'wss://infocode.ro/event/' # Optional
