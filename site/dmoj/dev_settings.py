...
SITE_ID = 1
SITE_NAME = 'Infocode'
SITE_LONG_NAME = 'Infocode: Your code dojo'
...
DMOJ_CAMO_EXCLUDE = ()
DMOJ_PROBLEM_DATA_ROOT = '/home/vitor/projetos/upwork/infocode/judge/problems/'
...
try:
    with open(os.path.join(os.path.dirname(__file__), 'dev_local_settings.py')) as f:
        exec(f.read(), globals())
except IOError:
    pass
